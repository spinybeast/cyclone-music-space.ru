angular.module('portfolioCtrl', [])
    ...
    .controller('portfolioController', function ($scope, $http, $sce, SoundCloud) {
        ...
        $scope.getSongUrl = function (id) {
            return $sce.trustAsResourceUrl("https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/" + id + "&color=ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=true&show_artwork=true");
        };
        $scope.showAll = true;
